...
Payback.Charts.drawUserLoanBorrow = (data) ->
...
Payback.Charts.drawCreditSegments = (data) ->
  @drawSegments('.user-credit-segments', data)


# Draw pie chart of who you borrow money from
Payback.Charts.drawDebtSegments = (data) ->
  @drawSegments('.user-debt-segments', data)


# Internal: Draw a pie chart mapping users to amount loaned/borrowed
Payback.Charts.drawSegments = (containerClass, data) ->
